...
function pijamasHombre($pdo, $from, $mensaje) {
    try {
        $articulo = 'pijamas de hombre';
...
function pijamasMujer($pdo, $from, $mensaje) {
    try {
        $articulo = 'pijamas de mujer';
...
function pijamasNino($pdo, $from, $mensaje) {
    try {
        $articulo = 'pijamas de niño';

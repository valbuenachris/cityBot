...
function decoracionInteriores($pdo, $from, $mensaje) {
    try {
        $articulo = 'decoracion interiores';
...
function decoracionExteriores($pdo, $from, $mensaje) {
    try {
        $articulo = 'decoracion exteriores';

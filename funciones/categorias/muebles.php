...
function camas($pdo, $from, $mensaje) {
    try {
        $articulo = 'camas';
...
function comedores($pdo, $from, $mensaje) {
    try {
        $articulo = 'comedores';
...
function escritorios($pdo, $from, $mensaje) {
    try {
        $articulo = 'escritorios';
...
function mesas($pdo, $from, $mensaje) {
    try {
        $articulo = 'mesas';
...
function sillas($pdo, $from, $mensaje) {
    try {
        $articulo = 'sillas';

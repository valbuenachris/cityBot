...
function vestidosBanoNino($pdo, $from, $mensaje) {
    try {
        $articulo = 'vestidos de baño infantil';
...
function vestidosBanoMujer($pdo, $from, $mensaje) {
    try {
        $articulo = 'vestidos de baño mujer';
...
function vestidosBanoHombre($pdo, $from, $mensaje) {
    try {
        $articulo = 'vestidos de baño hombre';

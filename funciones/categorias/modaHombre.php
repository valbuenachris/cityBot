...
function boxer($pdo, $from, $mensaje) {
    try {
        $articulo = 'boxer y medias';
...
function busos($pdo, $from, $mensaje) {
    try {
        $articulo = 'busos';
...
function camisas($pdo, $from, $mensaje) {
    try {
        $articulo = 'camisas';
...
function modaHombreCasual($pdo, $from, $mensaje) {
    try {
        $articulo = 'moda casual hombre';
...
function jeansPantalones($pdo, $from, $mensaje) {
    try {
        $articulo = 'jeans y pantalones';

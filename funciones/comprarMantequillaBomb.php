...
function comprarMantequillaBom($pdo, $from) {
    ...
    $stmt = $pdo->prepare("INSERT INTO pedidos (user_id, perfil, producto, precio) VALUES (?, 'comprando', 'Matequilla Bombombum', 35000)");
    $stmt->execute([$from]);
